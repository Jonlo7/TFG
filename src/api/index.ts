...
app.use((error: Error, req: Request, res: Response, _next: NextFunction) => {
  ...
  if ((error instanceof APIError && (error as APIError).isExposable()) || req.session.trabajador) { // to prevent leaking sensitive information. APIError are manually thrown wihout internal information
    newError = error;
  } else {
    newError.stack = '';
  }
